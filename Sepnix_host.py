...
@app.route('/')
def home():
    return "WELCOME SEPNIX HOSTING BOT"
...
TOKEN = os.getenv('TOKEN', '8965443188:AAHq1ToDamxIt9vwByQqN-anuT8_2tT7fUA')
OWNER_ID = int(os.getenv('OWNER_ID', 8417867026))
ADMIN_ID = int(os.getenv('ADMIN_ID', 8417867026))
YOUR_USERNAME = os.getenv('YOUR_USERNAME', 'SEPNIX')
UPDATE_CHANNEL = os.getenv('UPDATE_CHANNEL','SEPNIIX')
...
ADMIN_LIMIT = int(os.getenv('ADMIN_LIMIT', 50))
